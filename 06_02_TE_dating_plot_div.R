...
#Import the modified output from parseRM.pl ending with "landscape.Div.Rname.tab
  dat <- fread("06_TE_dynamics/polished.fasta.sed.tab")
...
#Estimate age of insertion
  ...
  #Change name of superfamilies
    ...
    rep_table.m$Superfamily <- factor(rep_table.m$Superfamily, levels = c("LTR/Gypsy", "LTR/Copia", "LTR/Unknown", "DNA/Helitron", "DNA/DTM", "DNA/DTC", "DNA/DTH", "DNA/DTA", "DNA/DTT", "LINE"))
  ...
  #Plot
    ...
    ggsave(filename = "TE-myr_lines.pdf", width = 10, height = 5, useDingbats = F)