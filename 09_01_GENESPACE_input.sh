...
#SBATCH --output=/data/users/srasch/assembly_course/Output/output_GENESPACE_input_%j.o
#SBATCH --error=/data/users/srasch/assembly_course/Error/error_GENESPACE_input_%j.e
...
#Specify directory structure and create them
    course_dir=/data/users/srasch/assembly_course
        input_dir=${course_dir}/07_TE_annotation/polished.maker.output
