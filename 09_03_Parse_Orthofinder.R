...
#Summarize Orthofinder statistics per species
  #Import dataset
    dat <- fread("C:/Users/sabri/OneDrive/Desktop/HS23/Genome and Transcriptome Assembly_Organization and annotation of Eukaryote genomes/Exercises/09_comp_genomics/Statistics_PerSpecies.tsv")
      ids=names(dat)
  ...
  #Plot
    p <- ggplot(o_ratio, aes(x =  V1, y = perc, fill = species)) +
         ...
         labs(y = "Count")
    ggsave("C:/Users/sabri/OneDrive/Desktop/HS23/Genome and Transcriptome Assembly_Organization and annotation of Eukaryote genomes/Exercises/09_comp_genomics/orthogroup_number_plot.pdf")
  ...
  p <- ggplot(o_percent, aes(x =  V1, y = perc, fill = species)) +
       ...
       theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
       labs(y = "Count")
  ggsave("C:/Users/sabri/OneDrive/Desktop/HS23/Genome and Transcriptome Assembly_Organization and annotation of Eukaryote genomes/Exercises/09_comp_genomics/orthogroup_percentage_plot.pdf")

#PLot co-occurrence of Orthogroups
  #Import dataset
    ogroups <- fread("C:/Users/sabri/OneDrive/Desktop/HS23/Genome and Transcriptome Assembly_Organization and annotation of Eukaryote genomes/Exercises/09_comp_genomics/Orthogroups.GeneCount.tsv")
  ...
  #Plot data using the ComplexUpset package
    pdf("C:/Users/sabri/OneDrive/Desktop/HS23/Genome and Transcriptome Assembly_Organization and annotation of Eukaryote genomes/Exercises/09_comp_genomics/one-to-one_orthogroups_plot.complexupset.pdf", height = 5, width = 10, useDingbats = FALSE)
